...
echo "Removing previous build of ArborX$QA_TEST_VARIANT"
...
echo ""
pwd
echo "Done with kokkos$QA_TEST_VARIANT build; building arborx$QA_TEST_VARIANT"
...
echo "-----------"
echo "Starting cmake of arborx$QA_TEST_VARIANT"
pwd
echo "arborx cmake \
...
echo "Starting make of arborx$QA_TEST_VARIANT"
