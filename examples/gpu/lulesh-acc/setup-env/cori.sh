...
then
  ...
  export HPCTOOLKIT_LULESH_ACC_SUBMIT="sbatch -q shared $HPCTOOLKIT_PROJECTID $HPCTOOLKIT_RESERVATION -N 1 -c 10 -C gpu -t 10"
  ...
  export HPCTOOLKIT_LULESH_ACC_BUILD="$HPCTOOLKIT_LULESH_ACC_SUBMIT -J lulesh-build -o log.build.out -e log.build.error"
