...
then
  ...
  module use /global/common/software/m3977/hpctoolkit/2021-11/cori-gpu/modules
  module load hpctoolkit/2021.11

  # modules for hpctoolkit
  export HPCTOOLKIT_MODULES_HPCTOOLKIT="module load hpctoolkit/2021.11"
