...
int 
hypre_LocateAssummedPartition(HYPRE_BigInt row_start, HYPRE_BigInt row_end, 
...
int
hypre_GetAssumedPartitionProcFromRow( HYPRE_BigInt row, HYPRE_BigInt global_num_rows, int *proc_id)
{
...
int
hypre_GetAssumedPartitionRowRange( int proc_id, HYPRE_BigInt global_num_rows, 
