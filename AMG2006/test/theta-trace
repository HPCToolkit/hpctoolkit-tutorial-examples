...
HPCRUN="/projects/Tools/hpctoolkit/pkgs-theta/hpctoolkit/bin/hpcrun -e REALTIME@300 -t"
...
aprun  -n \${RANKS} -N \${RANKS_PER_NODE} -d \${DEPTH} \${ENVS} -cc \${CPU_BINDING} \${HPCRUN} \${EXEC} \${ARGS}
